		...
		<>
			<div className={`flex items-center justify-between lg:flex-col lg:justify-center nike-container 
				...
				<div className="max-w-lg lg:max-w-none w-full md:text-center
					...
					<h1 className="text-5xl md:text-4xl sm:text-2xl font-bold 
					...
					<a href={url} className="flex items-center" target={"_blank"} role="button">
						<button type='button'
							className='button-theme bg-slate-900 shadow-slate-900 text-slate-100 py-1.5'>{btn}</button>
					</a>
				</div>
				<div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full">
					<img 
						...
						className={`w-auto object-fill transitions-theme 
							...
							'h-72 lg:h-64 md:-h-60 sm:h-48 sxm:h-40 rotate-[19deg] hover:rotate-12'}`}
					/>
				</div>
			</div>
		</>
